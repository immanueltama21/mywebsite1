...
if (isset($_GET['delete'])) {
    ...
    if($query)
    {
        ...
        <?php
    header('refresh:3; URL=http://localhost/anggota/admin.php?page=anggota');
    }
} 
if (isset($_POST['save'])) {
    ...
    if($query_insert)
    {
        ...
        <?php
    header('refresh:3; URL=http://localhost/APLIKASI_PEMROGRAMAN_IMMANUELTAMA_XIIRPL1/admin.php?page=anggota');
    }
